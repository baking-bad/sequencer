...
use crate::{AggregateSignature, Digest, PublicKey};
...
pub fn aggregate_verify(
    ...
    let sig = min_sig::Signature::from_bytes(signature.as_slice()).expect("Signature cast");
    ...
    let message = bcs::to_bytes(&IntentMessage {
        intent: Intent::narwal_header_digest_v0(),
        value,
    })
